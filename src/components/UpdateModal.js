...
import { Button, Container, Form, FormGroup, Input, Modal, ModalBody, ModalHeader } from 'reactstrap';
import { getItems, updateItem } from '../redux/actions/itemActions'

const UpdateModal = ({ isOn = false, setToggle, nameItem, priceItem, id }) => {
            ...
            <Modal isOpen={isOn} toggle={setToggle}>
                ...
                <ModalBody>
                    <Form onSubmit={onSubmit}>
                        <FormGroup>
                            <Input style={{ marginBottom: '1rem' }} type='text' name='name' id='itemName'
                                placeholder={nameItem} onChange={onChange}
                                required />
