...
const ItemCard = ({ id, itemId, name = 'item', price = 0, description = 'description', onDelete, onUpdate }) => {
  ...
  return (
    <Card key={id} inverse style={{ backgroundColor: '#333', borderColor: '#333', borderWidth: 10, borderRadius: 10, margin: 10, boxShadow: `${8}px ${8}px ${3}px black` }}>
      ...
      <CardBody>
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", flexDirection: "row" }}>
          ...
          <div style={{ display: "flex", alignItems: "center", justifyContent: "center", flexDirection: "column" }}>
            ...
            <Input style={{ width: 45, height: 30, padding: 5 }} type='number' name='quantity' id='itemQuantity'
              placeholder='1'
              min='1'
              onChange={onChange}
              required />
