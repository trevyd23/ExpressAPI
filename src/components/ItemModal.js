...
const ItemModal = () => {
    ...
    return (
        <Container style={{ width: '10rem', height: '10rem', alignItems: "center", justifyContent: "center" }} className='modal-container'>
                    ...
                    <Form onSubmit={onSubmit}>
                        <FormGroup>
                            <Input style={{ marginBottom: '1rem' }} type='text' name='name' id='itemName'
                                placeholder='Name of new item' onChange={onChange}
                                required />
