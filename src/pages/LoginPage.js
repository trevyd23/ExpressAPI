...
const LoginPage = () => {
    ...
    return (<>
        ...
        <ErrorModal />
        <Container style={{ height: `${height}px`, display: "flex", alignItems: "center", background: 'radial-gradient(circle, rgba(2,0,36,1) 0%, rgba(57,57,91,1) 20%, rgba(0,212,255,1) 100%)' }} fluid>
            <Fade in={fade} tag='h5' className='mt-4' style={{ width: '100%' }}>
                <Container style={{ height: '400px', width: '400px', padding: 20, borderRadius: '80px', border: '2px solid gray' }} className='loginContainer'>
                    ...
                    <Form >
                        ...
                        <Container style={{ display: "flex", justifyContent: "center" }}>
                            <Link to={"/shopping"} onClick={onSubmit}>
                                <Button style={{ width: '100px' }} className='btn'> {!fetching ? 'Submit' : 'Loading...'}
